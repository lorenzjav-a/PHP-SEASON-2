...
try {
    ...
    $mail->addAddress('bbetattest613@gmail.com'); // Use the variable from your form!
    ...
    $mail->Body     = "Fullname: Lorenz John A. Delizo your generated password is: <b>$password</b>";
